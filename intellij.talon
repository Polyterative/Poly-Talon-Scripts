...
line two one nine: key(ctrl-shift-alt-g delete 2 1 9 enter)
line two two zero: key(ctrl-shift-alt-g delete 2 2 0 enter)
line two two one: key(ctrl-shift-alt-g delete 2 2 1 enter)
line two two two: key(ctrl-shift-alt-g delete 2 2 2 enter)
line two two three: key(ctrl-shift-alt-g delete 2 2 3 enter)
line two two four: key(ctrl-shift-alt-g delete 2 2 4 enter)
line two two five: key(ctrl-shift-alt-g delete 2 2 5 enter)
line two two six: key(ctrl-shift-alt-g delete 2 2 6 enter)
line two two seven: key(ctrl-shift-alt-g delete 2 2 7 enter)
line two two eight: key(ctrl-shift-alt-g delete 2 2 8 enter)
line two two nine: key(ctrl-shift-alt-g delete 2 2 9 enter)
line two three zero: key(ctrl-shift-alt-g delete 2 3 0 enter)
line two three one: key(ctrl-shift-alt-g delete 2 3 1 enter)
line two three two: key(ctrl-shift-alt-g delete 2 3 2 enter)
line two three three: key(ctrl-shift-alt-g delete 2 3 3 enter)
line two three four: key(ctrl-shift-alt-g delete 2 3 4 enter)
line two three five: key(ctrl-shift-alt-g delete 2 3 5 enter)
line two three six: key(ctrl-shift-alt-g delete 2 3 6 enter)
line two three seven: key(ctrl-shift-alt-g delete 2 3 7 enter)
line two three eight: key(ctrl-shift-alt-g delete 2 3 8 enter)
line two three nine: key(ctrl-shift-alt-g delete 2 3 9 enter)
line two four zero: key(ctrl-shift-alt-g delete 2 4 0 enter)
line two four one: key(ctrl-shift-alt-g delete 2 4 1 enter)
line two four two: key(ctrl-shift-alt-g delete 2 4 2 enter)
line two four three: key(ctrl-shift-alt-g delete 2 4 3 enter)
line two four four: key(ctrl-shift-alt-g delete 2 4 4 enter)
line two four five: key(ctrl-shift-alt-g delete 2 4 5 enter)
line two four six: key(ctrl-shift-alt-g delete 2 4 6 enter)
line two four seven: key(ctrl-shift-alt-g delete 2 4 7 enter)
line two four eight: key(ctrl-shift-alt-g delete 2 4 8 enter)
line two four nine: key(ctrl-shift-alt-g delete 2 4 9 enter)